...
<popup-box>
    <div>
        ...
        <h2 style="background-color: rgba(0,0,0,0.3); box-shadow: 0 0 10px 10px rgba(0,0,0,0.3);">Ocado Technology: Mechanical Engineer</h2>
    ...
    <h3>My Role</h3>
    <img src="img/portfolio/ocado/bot.jpeg" style="width:80%;">
