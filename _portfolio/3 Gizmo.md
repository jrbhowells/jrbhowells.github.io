...
<popup-box>
    ...
    <p>A its name suggests, the Useless Box is a box that does very little that is of use to anyone. Its sole purpose in life is to turn itself off. The box can get progressively more ‘annoyed’ as the user turns the switch on - at first, it simply turns the switch back off but as it gets more exasperated about this not working, it starts to take more action - hiding the switch from the user, or even running away.</p>
